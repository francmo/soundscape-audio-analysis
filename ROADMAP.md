...
**Aggiornamento ROADMAP**: 15 maggio 2026 (caso Marozzi, vedi addendum)
...
### Addendum 15/05/2026 - caso Marozzi (Soundscape Annotation ABA Macerata)
...
design aperte: `ROADMAP_ADDENDUM_marozzi_2026-05-15.md`. Non sostituisce
...
Marozzi** (una sola release con i 3 interventi quantitativi). Decisioni
