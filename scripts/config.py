...
# v0.12.6 (P4 caso Marozzi): soglie PANNs differenziate per profilo narrativo.
...
# Auto-detection profilo narrativo (P4 caso Marozzi):
# - durata < 5 minuti
...
# v0.12.6 (P3 caso Marozzi): soglie di confidenza sul `dominant_panns` di una
...
# oltre 5s la dominante e' robusta. Driver: caso S5 Marozzi (0.74s) classificato
...
# v0.12.6 (P5 caso Marozzi): sub-segmentazione interna di sezioni geofoniche/
# biofoniche lunghe quando i PANNs sub-class variano nel tempo. Driver: S3
# Marozzi 80s collassa doccia (Water tap dominante) + lavandino (Sink
