...
# =====================================================================
# v0.12.6 (P3 + P5 caso Marozzi): test caveat sezioni brevi e
...
def test_short_section_signature_label_is_impulse_when_low_conf():
    ...
    signature_label = 'impulso e coda'. Caso scuola: S5 Marozzi 0.74s."""
    section = {
        "duration_s": 0.74,
...
def test_subsegment_section_splits_water_shower_vs_sink():
    """Caso scuola Marozzi S3: 80s di Water con top-3 PANNs che cambia
